...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
         ...
         alert(title="respuesta", message=f"el resultado de la suma es : {resultado}")
    ...
    def btn_restar_on_click(self):
         ...
         alert(title="respuesta", message=f"el resultado de la resta es : {resultado}")
         pass
    ...
    def btn_multiplicar_on_click(self):
         ...
         alert(title="respuesta", message=f"el resultado de la multiplicacion es : {resultado}")
    ...
    def btn_dividir_on_click(self):
         ...
         alert(title="respuesta", message=f"el resultado de la division es : {resultado}")
         pass
